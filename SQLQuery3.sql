...
--7. Selezionare tutti i videogame che hanno la categoria 2 (FPS) o 6 (RPG), mostrandoli una sola volta (del videogioco vogliamo solo ID) (287)
...
--2. Contare quante recensioni ha ricevuto ogni videogioco (del videogioco vogliamo solo ID) (500)
SELECT COUNT(videogame_id)
FROM reviews
GROUP BY videogame_id 

--3. Contare quanti videogiochi hanno ciascuna classificazione PEGI (della classificazione PEGI vogliamo solo ID) (13)
...
--5. Contare quanti videogiochi sono disponbiili per ciascun device (del device vogliamo solo ID) (7)
SELECT device_id, COUNT(*)
FROM device_videogame
GROUP BY  device_id

--6. Ordinare i videogame in base alla media delle recensioni (del videogioco vogliamo solo ID) (500)
...
--8. Selezionare le città  in cui A stato giocato il gioco dell anno del 2018 (36)
